...
function Almoxarifado() {
  ...
  // CATEGORIAS DE ITENS.
  let arraycategorias = ['0. DIETA', '1. ANTIMICROBIANOS', '2. DIVERSOS', '3. CURATIVOS', '4. CUIDADOS', 'COMPONENTE']
          ...
          <div id="btnUpdatePaciente"
            ...
            onClick={() => {
              let obj = {
                ...
                data_entrada: document.getElementById("inputDataEntrada").value,
